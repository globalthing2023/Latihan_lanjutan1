...
Kembalian = Kembalian - (1000 * Uang_1000)

print( f"SubTotal : {subTotal}")
print( f"Diskon : {Diskon}")
print( f"Total : {Total}")
print( f"Kembalian : {Bayar - Total}")
print( f"Kembalian_50000 : {Uang_50000}")
print( f"Kembalian_20000 : {Uang_20000}")
print( f"Kembalian_10000 : {Uang_10000}")
print( f"Kembalian_5000 : {Uang_5000}")
print( f"Kembalian_2000 : {Uang_2000}")
print( f"Kembalian_1000 : {Uang_1000}")